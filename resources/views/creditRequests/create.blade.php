...
<div id="infoBox" class="alert alert-success" ></div>
 ...
 <div class="content bg-image" style="background-image: url('/img/photo-profile.jpg');">
    <div class="push-50-t push-15 clearfix">
        ...
        <h1 class="h2 text-white push-5-t animated zoomIn" title="Solicitud de credito para la cotizacion -{{ $quotation->id }}">Credit Request for Quotation -{{ $quotation->id }} </h1>
    ...
    <div class="row">
        ...
        <div class="block">
                ...
                <div class="block-content">
                    <form class="js-validation-register form-horizontal push-50" method="POST" action="/quotations/{{ $quotation->id }}/credit-requests" enctype="multipart/form-data">
                                        
                        {{ csrf_field() }}
                        @include('creditRequests/partials/form') 
