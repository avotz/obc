...
<div id="infoBox" class="alert alert-success" ></div>
 ...
 <div class="content bg-image" style="background-image: url('/img/photo-profile.jpg');">
    <div class="push-50-t push-15 clearfix">
        ...
        <h1 class="h2 text-white push-5-t animated zoomIn" title="Editar solicitud de credito">Edit Credit Request </h1><small class="label label-{{ trans('utils.purchase_status_color.'.$creditRequest->status) }}">{{ trans('utils.credit_status.'.$creditRequest->status) }}</small>
