...
<div id="infoBox" class="alert alert-success" ></div>
 ...
 <div class="content bg-image" style="background-image: url('/img/photo-profile.jpg');">
    <div class="push-50-t push-15 clearfix">
        ...
        <h1 class="h2 text-white push-5-t animated zoomIn" title="Editar credito">Edit Credit </h1><small class="label label-{{ trans('utils.purchase_status_color.'.$credit->status) }}">{{ trans('utils.credit_status.'.$credit->status) }}</small>
    ...
    <div class="row">
        ...
        <div class="block">
                ...
                <div class="block-content">
                    <form class="js-validation-register form-horizontal push-50" method="POST" action="/credit/credits/{{ $credit->id }}" enctype="multipart/form-data">
