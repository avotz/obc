                ...
                <div class="block-content">
                    <table class="table table-striped table-vcenter">
                        ...
                        <tbody>
                           @foreach($credits as $credit)
                            <tr>
                                <td class="font-w600">{{ $credit->transaction_id }}</td>
                                
                                <td class="text-center">
                                    {{ $credit->quotation->user->companies->first()->public_code }}
                                       
                                </td>
                                <td class="font-w600"> {{ $credit->credit_time }} {{ trans('utils.days') }}</td>
                                <td class="hidden-xs">{{ Carbon\Carbon::parse($credit->date)->format('Y-m-d') }}</td>
                    ...
                    <div class="row">
                        <div class="col-sm-12 text-center" >
                            <div class="pagination-container">{!!$credits->render()!!}</div>
                        </div>
                    </div>
                    @endif
